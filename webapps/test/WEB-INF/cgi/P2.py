...
if form.getvalue('ar4'):
    ...
    ar4=''
if form.getvalue('ar5'):
    ar5=form.getvalue('ar5')
else:
    ar5=''
...
if  ar1 != '' and ar2 != '' and ar3 != '' and ar5 != '':
    arc = round(float(ar1),2) + round(float(ar2),2) + round(float(ar3),2) + round(float(ar5),2)

#solving for circumference
if diameter != '':
    circumference = round((float(diameter)*math.pi),2)
if  L1 != '' and L2 != '' and L3 != '' and L4 != '': 
    circumference = round(float(L1),2) + round(float(L2),2) + round(float(L3),2) + round(float(L4),2)
...
if ar2 != '' and ar3 != '' and ar5 != '' and arc != '':
    ar1 = round(float(arc),2) - round(float(ar2),2) - round(float(ar3),2) - round(float(ar5),2)
if ar1 != '' and ar3 != '' and ar5 != '' and arc != '':
    ar2 = round(float(arc),2) - round(float(ar1),2) - round(float(ar3),2) - round(float(ar5),2)
if ar1 != '' and ar2 != '' and ar5 != '' and arc != '':
    ar3 = round(float(arc),2) - round(float(ar1),2) - round(float(ar2),2) - round(float(ar5),2)
if ar1 != '' and ar2 != '' and ar3 != '' and arc != '':
    ar5 = round(float(arc),2) - round(float(ar1),2) - round(float(ar2),2) - round(float(ar3),2)
if ar5 != '' and art != '':
    ar4 = round(float(art),2) - round(float(ar5),2)
if ar4 != '' and art != '':
    ar5 = round(float(art),2) - round(float(ar4),2)

print("Content-Type: text/html")
print()
print("<form id='p2' method='post'>")
...
print("L4: <input name='L4' type='text' value=%s> <br /> <br />" % (L4))
...
print("ar5: <input name='ar5' type='text' value=%s> <br /> <br />" % (ar5))
