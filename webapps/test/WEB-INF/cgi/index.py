import cgi
#To access the website, go to http://127.0.0.1:8080/test/cgi-bin/index.py
...
print()
print("<form id='p1' method='post' action='Problem 1.py'>")
...
print("</form>")
print("<form id='p2' method='post' action='Problem 2.py'>")
...
print("<input type='submit' value='Solve'/> <br /> <br />")
print("</form>")
print("<form id='p3' method='post' action='Problem 3.py'>")
